package com.together.calendar.controller;

import com.together.calendar.bean.GetCalendars;
import com.together.calendar.bean.User_calendarDTO;
import com.together.calendar.service.CalendarService;
import com.together.calendar.service.CalendarServiceImpl;
...
public class CalendarController {
    ...
    private Optional<User_calendarDTO> getOneCalendar(@RequestBody String calendar_id) {
        ...
        if (calendarService == null) {
            System.out.println("서비스가 없어서 새로 임시로 만들었어요");
            CalendarService tempService = new CalendarServiceImpl();
            return tempService.getOneCalendar(id);
        } else {
