...
import com.together.common.security.jwt.JwtTokenProvider;
import com.together.common.security.jwt.filter.JwtAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        System.out.println("WebSecurity - filterChain: " + http);
        //폼 기반 로그인 비활성화
    ...
    public PasswordEncoder passwordEncoder(){
        System.out.println("WebSecurity - passwordEncoder");
    ...
    public AuthenticationManager authenticationManager(AuthenticationConfiguration authenticationConfiguration) throws Exception {
        System.out.println("WebSecurity - authenticationManager");
